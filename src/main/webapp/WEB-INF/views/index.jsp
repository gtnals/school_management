...
<body>
    <main>
        ...
        <fmt:formatNumber value="${value2}" pattern="0,000.0"/>
        <fmt:formatNumber value="${value2}" pattern="0,000원"/>
        ...
        <div class="content_area">
            <div class="department_info">
                ...
                <p><i class="fas fa-clock"></i> 업데이트 날짜 : <span><fmt:formatDate value="${update.department}" pattern="yyyy-MM-dd HH:mm:ss"/></span></p>
            </div>
            <div class="teacher_info">
                ...
                <p><i class="fas fa-clock"></i> 업데이트 날짜 : <span><fmt:formatDate value="${update.teacher}" pattern="yyyy-MM-dd HH:mm:ss"/></span></p>
            </div>
